...
export default function Blog({loggedUser}){
    ...
    return (
        <main>
            <div id="allBlogs" className="grid grid-cols-2 gap-4 justify-center m-16 font-poppins border-b-2 pb-16">
                {
            ...
            {
                    loggedUser && loggedUser.username ? <Link to="/blogs/create" className="text-xl  ml-16 font-poppins px-4 py-2 bg-slate-700 mt-2 text-slate-100  hover:bg-slate-500">Write your blog</Link> : <p className="text-md font-poppins ml-16 text-slate-800 py-2 mt-2">You need to create an account to publish your blogs</p>
            }
            <div id="cta" className=" flex flex-row items-center justify-center gap-5 border-b-2">
                ...
                <div className="flex flex-col text-left">
                    <h1 className="text-2xl font-poppins font-bold text-black">Ready to start your journey?</h1>
                    <p className="text-md text-black font-poppins break-words">Check out our very own test authoring suite! This suite allows you to create, edit, and preview posts in this blog!</p>
                    <Link to="/blogs/create" className="text-md px-4 py-1 mt-4 border-2 border-slate-500 font-poppins text-black w-fit  hover:bg-black hover:text-white hover:transition-all hover:duration-250ms">Go to Link</Link>
                </div>
            </div>    
            <div className="flex flex-col items-center justify-center mt-8 mb-16">
                ...
                <p className="text-md font-poppins mb-2 px-4 py-1">Follow us on all our socials!</p>
